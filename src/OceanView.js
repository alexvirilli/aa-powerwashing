...
/* Images */
// You can replace these with Ocean View-specific images
import margateHero from './images/home-hero.webp'; // Replace with Ocean View beach/town image
...
function OceanView() {
    const services = [
        {
            ...
            icon: <FaHome size={32} />,
            title: 'House Washing',
            description: 'Restore your Ocean View home’s exterior with our gentle but effective cleaning process.',
        ...
        },
        {
            ...
            description: 'Revitalize your Ocean View property’s walkways, patios, and driveways.',
        ...
        },
        {
            ...
            description: 'Enjoy crystal clear views of Ocean View’s surroundings.',
    ...
    const localFeatures = [
        {
            ...
            description: 'We understand Ocean View’s unique environment and the challenges it presents to homeowners.'
        },
        {
    ...
    return (
        <div className="town-page">
            <Helmet>
                <title>A&A Powerwashing | Ocean View, NJ</title>
                <meta name="description" content="Professional power washing services in Ocean View, NJ. Our eco-friendly solutions restore and protect your property from environmental damage." />
                <meta name="keywords" content="powerwashing Ocean View, pressure washing Ocean View, Ocean View property maintenance, Ocean View home services, property cleaning, A&A Powerwashing OceanView" />
                <meta property="og:title" content="A&A Powerwashing - Ocean View" />
                <meta property="og:description" content="Premier power washing services for Ocean View homes and businesses. Restore your property's beauty with our eco-friendly cleaning solutions." />
                <meta property="og:image" content="./images/new_logo.PNG" />
                <meta property="og:url" content="https://aapowerwashers.com/oceanview" />
            </Helmet>
            ...
            <section className="town-intro">
                <div className="town-intro-container">
                    <h2>Power Washing Services in Ocean View, NJ</h2>
                    <p>
                        A&A Powerwashing provides specialized cleaning services for Ocean View's unique environment. Local weather conditions and surface wear can quickly deteriorate your property's appearance and value. Our eco-friendly cleaning solutions are specifically formulated to address these challenges, protecting your investment while maintaining Ocean View's appeal.
                    </p>
                ...
                <div className="town-comparison-container">
                    <div className="town-comparison-item">
                        ...
                        <div className="town-comparison-text">
                            ...
                            <p>Accumulated grime on these Ocean View pavers was no match for our specialized cleaning process.</p>
